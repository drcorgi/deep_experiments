...
if __name__ == '__main__':
    ...
    data_x = up_(aes[:2],frames,seq_len=seq_len,training=True) # True
    # TODO: Augment data_x: forwards and backwards
    #data_x = [[data_x[j] for j in range(i,i+seq_len,1)] for i in range(len(data_x)-seq_len+1)] # for level-1
